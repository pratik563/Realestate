  ...
  return (
    ...
    >
      <div className="absolute inset-0 flex flex-col lg:flex-row items-center justify-center">
        <div className="bg-black/50 backdrop-blur-md p-6 w-full lg:w-[1300px] h-auto lg:h-[700px] rounded-lg flex flex-col lg:flex-row">
          {/* Left Side (Text) */}
          <div className="flex flex-col justify-center items-center lg:items-start px-4 lg:pl-6 w-full lg:w-1/2 mb-8 lg:mb-0">
            ...
            <p className="text-lg lg:text-xl font-medium text-white mt-4 mb-4 text-center lg:text-left">
              ...
              (PCMC). <br /> Established in 2005, We have been providing
              exceptional real estate services & building exclusive homes that
              meet the highest standards of quality & craftsmanship.
            </p>
            <a
              href="#"
